...
public class BusinessPublicDetail_Activity_scroll extends AppCompatActivity implements ViewPagerEx.OnPageChangeListener, BaseSliderView.OnSliderClickListener {

    SharedPreferences sharedPreferences;
    public static int fragment_no;
    TextView tv_number,tv_category,tv_address,tv_description,tv_label_dashboard;

    ImageView img_profile_pic,img_back,img_profile_tool_bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_public_detail_sroll);
...
//        Picasso.with(img_profile_pic.getContext()).load(""+sharedPreferences.getString("selected_image", "")).into(img_profile_pic);
        ...
        final Button btn_book_appt = findViewById(R.id.btn_book_appt);
        final Button btn_staff_list = findViewById(R.id.btn_staff_list);
        final Button btn_service_list = findViewById(R.id.btn_service_list);
        final Button btn_bus_info = findViewById(R.id.btn_bus_info);

        btn_book_appt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                        .addToBackStack(null)   // this will be it to the back stack
                ...
                btn_book_appt.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                btn_staff_list.setBackgroundColor(getResources().getColor(R.color.grey_light));
                btn_service_list.setBackgroundColor(getResources().getColor(R.color.grey_light));
        ...
        btn_staff_list.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn_book_appt.setBackgroundColor(getResources().getColor(R.color.grey_light));
                btn_service_list.setBackgroundColor(getResources().getColor(R.color.grey_light));
                btn_bus_info.setBackgroundColor(getResources().getColor(R.color.grey_light));
            }
        });
        ...
        btn_service_list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BusinessServiceListFragment tab1= new BusinessServiceListFragment();
                getSupportFragmentManager().beginTransaction()
                        .replace(R.id.frame_layout, tab1)
                        //.addToBackStack(null)   // this will be it to the back stack
                        .commit();
                btn_service_list.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                btn_book_appt.setBackgroundColor(getResources().getColor(R.color.grey_light));
                btn_staff_list.setBackgroundColor(getResources().getColor(R.color.grey_light));
                btn_bus_info.setBackgroundColor(getResources().getColor(R.color.grey_light));
            }
       ...
       /* int[] textureArrayWin = {
        ...
        if(textureArrayWin==null){
            ...
            for(int i=0;i<textureArrayWin.length;i++){
                ...
                TextSliderView textSliderView = new TextSliderView(BusinessPublicDetail_Activity_scroll.this);

                textSliderView
                        .description("")
                        .image(textureArrayWin[i])
                        .setScaleType(BaseSliderView.ScaleType.Fit)
                        .setOnSliderClickListener(BusinessPublicDetail_Activity_scroll.this);
            ...
            sliderLayout.addOnPageChangeListener(BusinessPublicDetail_Activity_scroll.this);
...
*/
            ...
            public void TaskCompletionResult(String result) {
                ...
                try {
                    ...
                    if(jsonObject.getString("status").equals("200")) {
                        ...
                        TextSliderView first_image = new TextSliderView(BusinessPublicDetail_Activity_scroll.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.item1:
                alertDialogShow_login(BusinessPublicDetail_Activity_scroll.this);
                        ...
                        try {
                            ...
                            if(jsonObject.getString("status").equals("200")) {
                                ...
                                if (jsonObject.getString("user_role"   ).equals("1")){
                                    Intent intent = new Intent(BusinessPublicDetail_Activity_scroll.this,MainActivity.class);
                                    ...
                                    Intent intent = new Intent(BusinessPublicDetail_Activity_scroll.this, StaffScreensActivity.class);
                                    startActivity(intent);
                                     finish();

                                } else if (jsonObject.getString("user_role"   ).equals("4")){
                                    //Customer bookappointment activity here
                                    Intent intent = new Intent(BusinessPublicDetail_Activity_scroll.this, CustomerBookingActivity.class);
                                    startActivity(intent);
                                }
