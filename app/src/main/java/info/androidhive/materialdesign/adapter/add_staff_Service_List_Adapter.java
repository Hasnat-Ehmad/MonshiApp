...
public class add_staff_Service_List_Adapter extends BaseAdapter {
    ...
    public add_staff_Service_List_Adapter(Activity context, List<ManagmentService_List> managmentService_lists) {
    ...
    private class ViewHolder {
        ...
        TextView tv_min,tv_amount,tv_name;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final add_staff_Service_List_Adapter.ViewHolder holder;
        ...
        if (convertView == null) {
            ...
            holder = new add_staff_Service_List_Adapter.ViewHolder();

            LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

            convertView = inflater.inflate(R.layout.list_view_add_staff_service, parent, false);
            ...
            holder = (add_staff_Service_List_Adapter.ViewHolder) convertView.getTag();
        }
        ...
        holder.tv_name.setText(""+item.getServicename());
        holder.tv_amount.setText(""+item.getAmount());
        holder.tv_min.setText(""+item.getTime());

        holder.toggle_btn = (ToggleButton) convertView.findViewById(R.id.toggle_btn);
