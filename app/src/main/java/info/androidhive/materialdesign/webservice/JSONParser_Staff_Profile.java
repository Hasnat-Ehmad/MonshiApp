 ...
 */
public class JSONParser_Staff_Profile {
     ...
     * @return
     */
    public JSONObject uploadImage(String sourceImageFile,//1
                                  String user_id,//2
                                  ...
                                  String roll,//7
                                  String expertise,//8
                                  String experience_years,//9
                                  String email,//10
                                  String mobilenumber,//11
                                  String staff_id,//12
                                  String all_operating_day,
     ...
     */
        String URL_UPLOAD_IMAGE = activity.getResources().getString(R.string.url) + "update_staff_checking.php";
        try {
...
//                    .build();
            ...
            RequestBody requestBody = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("staff_id",sharedPreferences.getString("staff_id", ""))
            ...
            Log.d("TAG", "File...:::: staff_id = " + sharedPreferences.getString("staff_id", ""));
