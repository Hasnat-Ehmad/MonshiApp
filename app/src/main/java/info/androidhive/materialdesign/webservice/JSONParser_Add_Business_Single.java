 ...
 */
public class JSONParser_Add_Business_Single {
    ...
    public JSONObject uploadImage(String sourceImageFile,
                                  String user_id, String business_title, String business_id,String business_type,String contact,String address,String state,
                                  String city,String industry,String sub_cat,String description,String all_operating_day,String check_operating_day,
     ...
     */
        String URL_UPLOAD_IMAGE = activity.getResources().getString(R.string.url) + "add_business.php";
        try {
