...
public class Monshi_Customers_List_Adapter extends BaseAdapter {
    ...
    public Monshi_Customers_List_Adapter(Activity context, List<Monshi_Customers_List> monshi_customers_lists) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Monshi_Customers_List_Adapter.ViewHolder holder;
                item = getItem(position);
        notifyDataSetChanged();

        if (convertView == null) {

            holder = new Monshi_Customers_List_Adapter.ViewHolder();
            ...
            holder = (Monshi_Customers_List_Adapter.ViewHolder) convertView.getTag();
        }
