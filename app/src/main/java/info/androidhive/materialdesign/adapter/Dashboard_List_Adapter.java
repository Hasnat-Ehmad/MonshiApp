...
public class Dashboard_List_Adapter extends BaseAdapter {
    ...
    static private List<Dashboard_List> dashboardLists = null;
    ...
    public Dashboard_List_Adapter(Activity context, List<Dashboard_List> dashboard_lists) {
        // TODO Auto-generated constructor stub
        this.mContext = context;
        this.dashboardLists = dashboard_lists;
    ...
    @Override
    public Dashboard_List getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Dashboard_List item = getItem(position);
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_dashboard, parent, false);
